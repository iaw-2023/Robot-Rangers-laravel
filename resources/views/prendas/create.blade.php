...
<div class="card col-6 offset-3 bg-gray-800 dark:bg-gray-900 shadow"style="border-color:black" >
  ...
  @include('messages')
     <form action="/prendas" method="POST">
        ...
        <div class="mb-3 bg-gray-800 dark:bg-gray-900" style="color:white">
            <label class="form-label bg-gray-800 dark:bg-gray-900" style="color:white">Marca_id</label>
            <input type="text" name="marca_id" class="form-control">
        </div>
        <div class="mb-3 bg-gray-800 dark:bg-gray-900" style="color:white">
            <label class="form-label bg-gray-800 dark:bg-gray-900" style="color:white">Categoria_id</label>
